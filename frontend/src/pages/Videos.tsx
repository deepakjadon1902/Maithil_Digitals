...
export function Videos() {
  ...
  return (
    <>
      <SEO seo={pageSeo("videos", { title: "Videos | Maithil Digitals", description: "Watch reels, campaign videos, brand videos and social media content by Maithil Digitals." })} />
