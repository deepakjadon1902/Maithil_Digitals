...
export const serviceSchema = z.object({
  ...
  problems: z.union([z.array(z.string()), z.string()]).optional().default([]),
  approach: z.union([z.array(z.string()), z.string()]).optional().default([]),
  capabilities: z.union([z.array(z.string()), z.string()]).optional().default([]),
